...
run_case() {
    ...
    local run_dir="${OUT_ROOT}/accum2_${cpu_label}_N${n}/"
    local tmp_report_file="${ROOT_DIR}/accum2_${cpu_label}_N${n}.txt"
    local report_file="${run_dir}/accum2_${cpu_label}_N${n}.txt"
    ...
    gem5_cmd="$GEM5_BIN ${ROOT_DIR}/$script_name --binary $GEMM_BIN --n ${n} --mode accum2"
