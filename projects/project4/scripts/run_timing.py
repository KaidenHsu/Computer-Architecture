...
def build_parser(default_l1d: str = "32KiB") -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser()
    parser.add_argument("--binary", type=str, default="./gemm_accel.riscv")
    parser.add_argument("--n", type=str, default="128")
    parser.add_argument("--mode", type=str, default="baseline")
    parser.add_argument("--l1i_size", type=str, default="32KiB")
    parser.add_argument("--l1d_size", type=str, default=default_l1d)
    return parser


def run(cpu_type, args):
