...
run_case() {
    ...
    local run_dir="${OUT_ROOT}/unrolled4_${cpu_label}_N${n}/"
    local tmp_report_file="${ROOT_DIR}/unrolled4_${cpu_label}_N${n}.txt"
    local report_file="${run_dir}/unrolled4_${cpu_label}_N${n}.txt"
    ...
    gem5_cmd="$GEM5_BIN ${ROOT_DIR}/$script_name --binary $GEMM_BIN --n ${n} --mode unrolled4"
